<template>
  ...
  >
    <Header1
      ...
      kursplannung="Kugu Dashboard"
      kurskonfigurator="Trainer:IN management"
      fRAMEWidth="32.13rem"
      wBSArrowIconFlex="1"
      wBSArrowIconMinWidth="6.69rem"
      kursplannungFlex="1"
      kursplannungMinWidth="6.94rem"
      :onWBSArrowIconClick="onWBSArrowIconClick"
      :onWBSArrowIcon1Click="onWBSArrowIcon1Click"
      :onFrameContainerClick="onFrameFrameContainerClick"
    />
    <main
    ...
    >
      ...
      >
        ...
        >
          <ArrowVector
            trainspotFrame="/frame-586.svg"
            screenshot20240125At14341="/screenshot-20240125-at-1434-1@2x.png"
            propPadding="0rem 0.06rem 0.06rem 0rem"
            propMinWidth="11.59rem"
            propPadding1="0.06rem 0rem 0rem"
          ...
          <div class="self-stretch h-[76.5rem] relative inline-block">
            ...
            <p class="m-0">
              <b>Purpose: </b>
              <span
                >Streamlining the management of trainer data within an
                organization.</span
              >
            </p>
            <p class="m-0">
            ...
            <ul class="m-0 text-inherit pl-[1.36rem]">
              <li class="mb-[false]">
                ...
                <span
                  >Facilitates profile management and communication for various
              ...
              <li class="mb-[false]">
                ...
                <span class="font-roboto-mono"
                  >Central repository for trainer data.</span
                >
              </li>
              <li class="mb-[false]">
                <b class="font-roboto-mono">Data Export:</b>
                <span class="font-roboto-mono"
                  >Enables downloading trainer data into Excel.</span
                >
              </li>
              <li class="mb-[false]">
                <b class="font-roboto-mono">Serial Email Functionality: </b>
                <span class="font-roboto-mono"
                  >Allows sending requests directly from the system.</span
                >
              </li>
            </ul>
            <p class="m-0">
            ...
            <ul class="m-0 text-inherit pl-[1.36rem]">
              <li class="mb-[false]">
                ...
                <span class="font-roboto-mono"
                  >Simplifies data management processes.</span
                >
              </li>
              <li class="mb-[false]">
                <b class="font-roboto-mono">Scalability: </b>
                <span class="font-roboto-mono"
                  >Adaptable for future expansion or integration.</span
                >
              </li>
            </ul>
            <p class="m-0">
