<template>
  <div
    class="self-stretch flex flex-row items-center justify-between py-[0rem] px-[0.63rem] gap-[1.25rem] text-left text-[1rem] text-white font-roboto-mono mq750:flex-wrap"
